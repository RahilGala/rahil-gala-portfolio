...
const INITIAL_PROJECTS = [
  {
    ...
    description:
      "Executed comprehensive data cleaning pipeline on 250+ IMDB records using MySQL 8.0, reducing corrupted values from 30% to 0% through systematic quality improvement processes.",
    points: [
  ...
  },
  {
    ...
    description:
      "Engineered interactive dashboard analyzing market data with 15+ KPIs including turnover, volatility, price changes, and market capitalization across 50 stocks.",
    points: [
  ...
  },
  {
    ...
    description:
      "Analyzed 134,000+ hotel booking records using Python and Pandas, performing data cleaning, outlier detection, and missing value imputation achieving 99% data quality.",
    points: [
    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-neutral-950 text-black dark:text-white font-sans selection:bg-green-400 selection:text-black pb-20 transition-colors duration-300">
      ...
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${
          isScrolled
            ? "bg-white/95 dark:bg-neutral-950/95 backdrop-blur-sm border-b border-gray-100 dark:border-neutral-800 py-4"
            : "bg-transparent py-6"
        }`}
      >
        <div className="max-w-[90rem] mx-auto px-6 md:px-12 flex items-center justify-between">
          <button
            ...
            className="font-bold text-lg tracking-[0.2em] uppercase dark:text-white cursor-pointer"
          >
            Rahil Gala
          </button>
              ...
              {["About", "Skills", "Projects", "Education", "Contact"].map(
                (item) => (
                  <button
                    ...
                    className={`nav-link ${
                      activeSection === item.toLowerCase() ? "active" : ""
                    } block w-full text-left py-2 text-sm font-bold tracking-[0.15em] uppercase transition-colors ${
                      activeSection === item.toLowerCase()
                        ? "text-green-600 dark:text-green-400"
      ...
      <section
        id="home"
        className="min-h-screen flex flex-col items-center relative pt-20 px-6 reveal-on-scroll"
        ref={heroRef}
      >
        ...
        <div className="py-12 flex gap-8 text-gray-400 dark:text-gray-500">
          <a
            href="https://www.linkedin.com/in/rahil-gala/"
            className="hover:text-black dark:hover:text-white transition-colors"
          >
            <Linkedin className="w-5 h-5" />
          </a>
          <a
            href="https://github.com/RahilGala"
            className="hover:text-black dark:hover:text-white transition-colors"
          >
            <Github className="w-5 h-5" />
          </a>
          <a
            href="mailto:rahilgala30@gmail.com"
            className="hover:text-black dark:hover:text-white transition-colors"
          >
      ...
      <section
        id="about"
        className="py-24 md:py-40 bg-white dark:bg-neutral-950 reveal-on-scroll"
      >
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          <div className="mb-24">
            <p className="text-xs font-bold tracking-[0.25em] text-gray-500 dark:text-gray-400 uppercase mb-6">
              Who I Am
            </p>
          ...
          <div className="max-w-5xl">
            <p className="text-2xl md:text-5xl leading-[1.2] font-medium text-gray-900 dark:text-gray-200">
              Aspiring Data Analyst with hands-on expertise in{" "}
              <span className="text-green-400 dark:text-green-600">
                SQL, Python, Power BI, and Tableau.
              </span>{" "}
              Proven ability to transform raw, messy datasets into actionable
              insights through advanced data cleaning, statistical analysis, and
              visualization.
            </p>
            <div className="mt-16 flex items-center gap-6">
              <div className="h-px bg-black dark:bg-white w-32"></div>
              <p className="text-xs font-bold uppercase tracking-[0.2em] dark:text-white">
                Deloitte & BCG Certified
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        id="skills"
        className="py-24 md:py-40 bg-[#FAFAFA] dark:bg-neutral-900 reveal-on-scroll"
      >
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          <div className="mb-24">
            <p className="text-xs font-bold tracking-[0.25em] text-gray-500 dark:text-gray-400 uppercase mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            {skills.map((data) => (
              <div
                key={data.category}
                className="card-lift group reveal-on-scroll relative bg-white dark:bg-neutral-950 p-12 shadow-sm border border-gray-100 dark:border-neutral-800 hover:shadow-xl hover:border-gray-200 dark:hover:border-neutral-700 transition-all duration-300"
              >
                ...
                <div className="flex flex-wrap gap-3">
                  {data.items.map((skill, i) => (
                    <span
                      key={i}
                      className="px-5 py-3 bg-gray-50 dark:bg-neutral-900 text-gray-700 dark:text-gray-300 text-sm font-medium border border-gray-100 dark:border-neutral-800"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="space-y-32">
            {projects.map((project) => (
              <div
                key={project.id}
                className="card-lift relative group reveal-on-scroll border-t border-gray-200 dark:border-neutral-800 pt-12"
              >
                ...
                <div className="flex flex-wrap gap-2 mb-10">
                  {project.tech.map((t, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 text-[10px] font-bold uppercase tracking-widest"
                    >
                      {t}
                    </span>
                  ))}
                  ...
                  <div className="md:col-span-7">
                    ...
                    <ul className="space-y-4">
                      {project.points.map((point, i) => (
                        <li
                          key={i}
                          className="flex items-start gap-4 text-sm text-gray-500 dark:text-gray-400 leading-relaxed"
                        >
                      ...
                      {project.stats &&
                        project.stats.map((stat, i) => (
                          <div key={i}>
                            <CountUp
                              value={stat.value}
                              className="text-4xl font-bold text-black dark:text-white mb-1"
                            />
                            <p className="text-[10px] font-bold tracking-[0.2em] text-green-600 dark:text-green-400 uppercase">
                              {stat.label}
                            </p>
                          </div>
                        ))}
      ...
      <section
        id="education"
        className="py-24 md:py-40 bg-[#FAFAFA] dark:bg-neutral-900"
      >
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
            ...
            <div className="space-y-12 pt-4">
              <div className="border-l-2 border-green-400 pl-10">
                ...
                <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                  Coursework: Data Analysis, Software Engineering, Algorithms,
  ...
  <div className="max-w-[90rem] mx-auto px-6 md:px-12">
    <div className="grid md:grid-cols-2 gap-16 md:gap-20 items-start">
      ...
      <div>
        ...
        <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-black dark:text-white mb-6 leading-none">
          Contact
          <br />
          Me
        </h2>

        <p className="text-2xl md:text-3xl font-medium text-gray-900 dark:text-gray-200 mb-6 leading-tight">
          Let's collaborate on your next{" "}
          <span className="text-green-500">data project.</span>
        </p>

        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-lg">
          I'm available for contract and full-time opportunities. Share a brief
          about the project and I'll respond within a few business days.
        </p>
      </div>

      {/* RIGHT CONTENT */}
      <div className="space-y-6 max-w-xl">
        {/* EMAIL + LOCATION (HALF / HALF) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {/* EMAIL */}
          <div className="bg-gray-50 dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 rounded-lg p-6">
            <p className="text-[10px] font-bold tracking-[0.2em] text-gray-400 dark:text-gray-500 uppercase mb-2">
              Email
            </p>

            <a
              href="mailto:rahilgala30@gmail.com"
              className="block text-lg font-bold hover:text-green-500 dark:text-white dark:hover:text-green-400 transition-colors"
            >
              rahilgala30@gmail.com
            </a>

            <a
              href="mailto:rahilgala30@gmail.com"
              className="mt-4 inline-block px-4 py-2 bg-green-400 hover:bg-green-500 text-black font-bold rounded"
            >
              Email Me
            </a>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 rounded-lg p-6">
            ...
            <div className="mt-4 inline-block px-4 py-2 border border-gray-200 dark:border-neutral-700 rounded font-bold">
        ...
        <a
          href="RAHIL_GALA_RESUME_DATA_ANALYTICS.pdf"
          download
          className="inline-flex w-full items-center justify-center gap-2 px-4 py-4 bg-white dark:bg-neutral-900 border border-black dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-800 text-black dark:text-white text-sm font-bold tracking-[0.2em] uppercase rounded transition-all"
        >
          <Download className="w-4 h-4" />
          Download Resume
        </a>

        {/* CONNECT WITH ME – FULL */}
        <div className="pt-6 border-t border-gray-200 dark:border-neutral-800">
          <p className="text-[10px] font-bold tracking-[0.2em] text-gray-400 dark:text-gray-500 uppercase mb-4">
            Connect With Me
          </p>
          ...
          <div className="flex gap-6">
            <a
              href="https://www.linkedin.com/in/rahil-gala/"
              className="flex items-center gap-2 text-lg font-bold hover:text-green-500 dark:text-white dark:hover:text-green-400 transition-colors"
            >
              <Linkedin className="w-5 h-5" />
              LinkedIn
            </a>
